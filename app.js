...
(function () {
  ...
  var I18N = {
    ...
    zh: {
      ...
      position_line: "合伙人主导 · ACCA资质 · 四大背景",

      home_kicker: "独立审计机构",
      home_h1: "Bastom Audit LLC — 乌兹别克斯坦审计、税务与咨询服务",
      home_p: "我们为股东、管理层和贷款机构提供高质量的审计服务和务实的咨询服务。时间安排清晰，收费透明，由合伙人亲自主导。",
      home_trust1: "审计机构国家登记册",
      home_trust2: "国际财务报告准则与管理报告",
      home_trust3: "保密与独立",

      home_services_kicker: "我们的服务",
      home_services_h2: "成果清晰，严守准则。",
      home_services_p: "一套符合国际准则和乌兹别克斯坦监管环境的实用服务。",
      ...
      svc_audit_p: "法定审计和委托审计、商定程序，以及面向利益相关方的鉴证服务。",
      svc_tax_p: "税务诊断、合规支持，以及交易和文档方面的咨询。",
      svc_out_p: "记账、月末结账、管理报告、薪酬核算及财务总监支持。",
      svc_model_p: "为贷款机构和投资者提供预算编制、财务预测、可行性研究和情景建模。",
      svc_ops_p: "流程诊断、KPI体系、内部控制及绩效提升。",
      svc_ifrs_p: "国际财务报告准则转换支持、会计备忘录及报告改进（非审计咨询）。",

      svc_audit_full: "依据国际审计准则（ISA）和乌兹别克斯坦审计法规开展法定审计和委托审计。我们以风险导向程序、实质性测试以及与管理层和股东的透明沟通为基础，出具清晰、及时的审计意见。我们还为贷款机构、投资者和监管机构提供商定程序（AUP）业务和鉴证报告。",
      svc_tax_full: "依据乌兹别克斯坦税法开展税务诊断，识别风险和优化机会。我们就交易架构、转让定价文档、增值税、企业所得税及工资相关税费提供咨询，并协助客户与税务机关沟通、处理申诉，以及在税务检查前开展合规审查。",
      svc_out_full: "按照乌兹别克斯坦国家会计准则（NSBU）或国际财务报告准则（IFRS）提供全流程记账、月末结账和管理报告服务。我们的外包团队负责薪酬核算、法定申报和账目编制，让管理层能够专注于经营。我们还为处于转型或重组阶段的公司提供临时财务总监和总会计师支持。",
      svc_model_full: "为贷款机构、投资者和董事会编制预算、财务预测和多情景财务模型。我们按照国际最佳实践编制可行性研究、商业计划书和投资评估。我们的模型透明、可审计，旨在支持决策，而不仅仅是满足合规要求。",
      svc_ops_full: "为希望加强公司治理的企业提供流程诊断、内部控制审查和KPI体系搭建服务。我们识别瓶颈、控制缺陷和报告漏洞，并提出管理层可落地执行的实用建议。服务范围根据企业规模和行业确定，成果可直接用于向董事会或股东汇报。",
      svc_ifrs_full: "国际财务报告准则转换、首次采用支持，以及针对复杂交易的持续会计备忘录服务。我们在IFRS 9（金融工具）、IFRS 16（租赁）、IFRS 17（保险合同）和IFRS 15（收入）方面拥有丰富经验。该服务属于非审计咨询，完全独立于任何法定审计业务。",

      how_kicker: "工作方式",
      how_h2: "流程规范，没有意外。",
      how_p: "从确定范围到交付成果共四个步骤，沟通清晰，成果有据可查。",
      step1: "确定范围",
      step1p: "启动会议，明确目标、时间表和资料清单。",
      step2: "服务方案",
      step2p: "明确工作范围、交付成果、收费及业务约定书。",
      step3: "现场工作",
      step3p: "测试、分析、访谈及阶段性进展汇报。",
      step4: "交付成果",
      step4p: "最终成果、管理建议书及总结沟通。",

      about_title: "关于 Bastom Audit",
      about_intro: "Bastom Audit LLC 是一家总部位于乌兹别克斯坦塔什干的独立审计与咨询公司。我们已列入审计机构国家登记册，由具有ACCA资质和四大会计师事务所工作经验的专业人士领导。我们的团队将国际准则引入乌兹别克斯坦市场，以股东、贷款机构和监管机构所期望的严谨与透明，提供审计、税务、国际财务报告准则及咨询服务。",
      about_intro2: "我们服务于保险、银行和能源行业，也服务于正在进行重组、融资或面临监管变化的私营企业。所有项目均由合伙人主导，客户直接与实际执行工作的人员沟通。",
      about_mission_h: "使命",
      about_mission_p: "提供独立、高质量的审计与咨询服务，帮助乌兹别克斯坦的机构达到国际准则要求，并在业务的每个阶段做到清晰、诚信、务实。",
      about_values_h: "原则",
      about_values_p: "每项业务均保持独立与客观。开展工作前明确收费和工作范围。合伙人从启动到交付全程直接参与。严格保密，审计与咨询业务相互分离。",
      about_details_h: "公司信息",
      about_legal: "法定全称：",
      about_addr: "地址：",
      about_license: "注册：",
      about_issued: "确认机构：",
      ...
      about_phone: "电话：",
      about_email: "电子邮箱：",
      about_register: "已列入乌兹别克斯坦共和国财政部审计机构国家登记册",

      services_title: "我们的服务",
      services_intro: "一套符合国际准则和乌兹别克斯坦监管环境的实用服务。所有项目均由合伙人主导，工作范围明确，收费透明，成果有据可查。",

      contact_title: "联系我们",
      contact_intro: "请告诉我们您的需求，我们通常会在1个工作日内回复。",
      contact_direct: "直接联系方式",

      footer_tag: "乌兹别克斯坦独立审计、税务与咨询服务。",
      footer_quick: "快速链接",
